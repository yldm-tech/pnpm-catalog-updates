...
AI プロバイダーのステータスを確認し、AI 分析キャッシュを管理します。
...
<Properties>
  <Property name="--status" type="boolean">
    すべての AI プロバイダーのステータスを表示（デフォルト）
  </Property>
  <Property name="--test" type="boolean">
    サンプルリクエストで AI 分析をテスト
  </Property>
...
PCU は利用可能な AI CLI ツールを自動的に検出して使用します：

| プロバイダー | CLI ツール | 検出方法                    |
| ------------ | ---------- | --------------------------- |
| Claude       | `claude`   | PATH 検索とバージョン出力   |
| Gemini       | `gemini`   | PATH 検索とバージョン出力   |
| OpenAI       | `codex`    | PATH 検索とバージョン出力   |
...
検出されたすべての AI プロバイダーを、利用可能状況、パス、バージョンとともに表示します。
...
サンプルの依存関係更新でテスト実行し、AI 分析が機能することを確認します。
