...
Vérifier l'état des fournisseurs AI et gérer le cache d'analyse AI.
...
<Properties>
  <Property name="--status" type="boolean">
    Afficher l'état de tous les fournisseurs AI (par défaut)
  </Property>
  <Property name="--test" type="boolean">
    Tester l'analyse AI avec une requête d'exemple
  </Property>
...
### Fournisseurs AI pris en charge

PCU détecte et utilise automatiquement les outils CLI AI disponibles :

| Fournisseur | Outil CLI | Méthode de détection                      |
| ----------- | --------- | ----------------------------------------- |
| Claude      | `claude`  | Recherche dans PATH et sortie de version  |
| Gemini      | `gemini`  | Recherche dans PATH et sortie de version  |
| OpenAI      | `codex`   | Recherche dans PATH et sortie de version  |

### Exemples d'utilisation

#### Afficher l'état des fournisseurs

```bash
pcu ai
```

Affiche tous les fournisseurs AI détectés avec l'état de disponibilité, le chemin et la version.
...
Exécute un test avec une mise à jour de dépendance d'exemple pour vérifier que l'analyse AI fonctionne.
