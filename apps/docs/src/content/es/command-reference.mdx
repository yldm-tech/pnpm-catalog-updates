...
PCU detecta y utiliza automáticamente las herramientas CLI de AI disponibles:

| Proveedor | Herramienta CLI | Método de Detección                   |
| --------- | --------------- | ------------------------------------- |
| Claude    | `claude`        | Búsqueda en PATH y salida de versión  |
| Gemini    | `gemini`        | Búsqueda en PATH y salida de versión  |
| OpenAI    | `codex`         | Búsqueda en PATH y salida de versión  |
...
Muestra todos los proveedores AI detectados con estado de disponibilidad, ruta y versión.
...
Ejecuta una prueba con una actualización de dependencia de ejemplo para verificar que el análisis AI funciona.
