...
检查 AI 提供者状态、测试 AI 分析功能和管理 AI 缓存。
...
- **自动检测**：PCU 自动检测已安装的 AI CLI 工具
- **优先级选择**：使用最高优先级的可用提供者
- **智能缓存**：结果被缓存以避免冗余 API 调用
- **优雅降级**：当没有 AI 工具可用时回退到基于规则的分析
